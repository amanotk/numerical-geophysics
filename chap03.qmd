...
[![](figure/colab-badge.svg)](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/LinearAdvectionEquation.ipynb){target="_blank"}
:::
:::
:::
...
![Ref: Matsumoto et al. (2019, PASJ)](figure/convergence.png){height="400"}
...
::: {.column-page width=800 height=600}
::: {.absolute top=0 right=50 height=32}
[![](figure/colab-badge.svg)](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/vonNeumannStabilityAnalysis.ipynb){target="_blank"}
:::
:::
:::
...
![Ref: Laney (1998)](figure/kdx.png){height="600"}
...
::: {.column width="50%"}
![Ref: Mellott (1985)](figure/dispersivewave.png){height=300}
:::
...
![Ref: Toro (2009)](figure/first-order-upwind.png){height="500"}
...
![](figure/linear_advection_ftbs.png){height="600"}
...
![](figure/linear_advection_lf.png){height="600"}
...
::: {.column-page width=800 height=600}
::: {.absolute top=0 right=50 height=32}
[![](figure/colab-badge.svg)](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/LinearWaveEquation.ipynb){target="_blank"}
:::
:::
:::
...
![Ref: Toro (2009)](figure/conservative-scheme.png){height=400}
