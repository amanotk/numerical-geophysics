...
::: header
  [![](figure/colab-badge.svg){width=117, height=20}](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/LinearAdvectionEquation.ipynb)
:::
...
![](figure/convergence.png){height="400"}

::: header
Ref: Matsumoto et al. (2019, PASJ)
:::
...
::: header
  [![](figure/colab-badge.svg){width=117, height=20}](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/vonNeumannStabilityAnalysis.ipynb)
:::
...
![](figure/vonneumann_ftcs.png){.absolute top=200 left=50 height="300"}
![](figure/dispersivewave.png){.absolute top=200 left=700 height="300"}
...
![](figure/first-order-upwind.png){height="500"}
...
::: header
  [![](figure/colab-badge.svg){width=117, height=20}](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/LinearWaveEquation.ipynb)
:::
...
![](figure/conservative-scheme.png){height=400}
