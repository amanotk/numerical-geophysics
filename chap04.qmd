...
::: header
  [![](figure/colab-badge.svg){width=117, height=20}](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/BurgersEquation.ipynb)
:::
...
![](figure/steepening.png){height=380}

::: header
Ref: Burgess & Scholer (Collisionless Shocks in Space Plasmas)
:::
...
![](figure/burgers-shock.png){height=600}
...
![](figure/burgers-rarefaction.png){height=600}
...
![](figure/burgers-expansion-shock.png){height=600}
...
::: header
  [![](figure/colab-badge.svg){width=117, height=20}](https://colab.research.google.com/github/amanotk/numerical-geophysics/blob/main/notebook/EulerEquation.ipynb)
:::
...
![](figure/characteristics.png){height=500}
...
### 応用例2
![](figure/piecewise-linear.png){height=300}
...
![](figure/linear-riemann-problem.png){height=300}
...
![](figure/hll-riemann-solver.png){height=300}
...
![](figure/hllc-riemann-solver.png){height=300}
...
![](figure/hll-family.png){height=500}
